...
The number of possible boards in the chess game is not that huge. However, the number of possible boards in Go is insanely high. That said, you will understand why solving the Go Game was harder than solve Chess Game, and why solving the Stracraft 2 game, is even harder.
...
<figure>
  ...
  <figcaption>Games complexity.</figcaption>
</figure>
